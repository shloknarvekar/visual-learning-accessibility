        ...
        <div className="mx-auto flex max-w-7xl justify-center">
          ...
          >
            ...
            >
              ...
              <span
                className={`font-heading text-[21px] tracking-tight sm:text-[24px] ${foreground}`}
              >
                VisuaLearn
              </span>
              <span
                className={`select-none text-[24px] leading-none sm:text-[29px] ${foreground}`}
                aria-hidden="true"
              >
                ✳︎
              </span>
            ...
            <nav
              className={`hidden items-center gap-1 md:flex ${foreground}`}
                  ...
                  >
                    ...
                    {view === target && (
                      <motion.span
                        ...
                        className={`absolute inset-x-4 -bottom-0.5 h-px ${landing ? "bg-white/80" : "bg-[#b4002a]"}`}
                      />
                    )}
                  </motion.button>
                </React.Fragment>
